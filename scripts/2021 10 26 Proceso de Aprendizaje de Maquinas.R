...
# 20 de octubre 2021
# Objetivo de aprendizaje: familiarizarse con el proceso de correr una máquina de aprendizaje
# No distraerse con los detalles del modelo empleado como clasificador en este caso.
##############################################################
...
################################################
# En este modelo en particular, sólo con llamar la función "plot" podemos ver
# qué números ajustó con los datos para usar luego en las predicciones
plot(n)
...
# Matriz de confusión & Error de clasificación - datos nuevos (de prueba)
